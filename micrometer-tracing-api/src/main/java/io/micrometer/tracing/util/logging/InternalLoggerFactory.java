 ...
 * Micrometer should use.  The default factory is {@link io.micrometer.tracing.util.logging.Slf4JLoggerFactory}.  If SLF4J
 * is not available, {@link io.micrometer.tracing.util.logging.JdkLoggerFactory} is used.  You can change it to your preferred
 * logging framework before other Micrometer classes are loaded:
 * <pre>
 * {@link InternalLoggerFactory}.setDefaultFactory({@link io.micrometer.tracing.util.logging.JdkLoggerFactory}.INSTANCE);
 * </pre>
