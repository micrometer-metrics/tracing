...
class CompositeTextMapPropagatorTest {
    ...
    void extract_onlyBaggage() {
        CompositeTextMapPropagator compositeTextMapPropagator = new CompositeTextMapPropagator(new CompositeTextMapPropagator.PropagationSupplier() {
            @Override
    ...
    void should_map_propagaotr_string_class_names_to_actual_classes() {
        CompositeTextMapPropagator propagator = new CompositeTextMapPropagator(new CompositeTextMapPropagator.PropagationSupplier() {
            @Override
            public <T> ObjectProvider<T> getProvider(Class<T> clazz) {
                return Supplier::get;
            }
