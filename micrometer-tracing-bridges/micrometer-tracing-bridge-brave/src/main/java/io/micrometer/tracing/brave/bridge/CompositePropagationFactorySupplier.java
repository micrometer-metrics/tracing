...
import org.springframework.boot.autoconfigure.observability.tracing.brave.propagation.PropagationType;
...
class CompositePropagationFactory extends Propagation.Factory implements Propagation<String> {
	...
	private static final class LazyPropagationFactory extends Factory {
		...
		private final ObjectProvider<Factory> delegate;

		private volatile Factory propagationFactory;

		private LazyPropagationFactory(ObjectProvider<Factory> delegate) {
