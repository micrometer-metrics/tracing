...
public class BraveCurrentTraceContext implements CurrentTraceContext {
    ...
    public Scope newScope(TraceContext context) {
        return new BraveScope(this.delegate.newScope(io.micrometer.tracing.brave.bridge.BraveTraceContext.toBrave(context)));
    }

    @Override
    public Scope maybeScope(TraceContext context) {
        return new BraveScope(this.delegate.maybeScope(io.micrometer.tracing.brave.bridge.BraveTraceContext.toBrave(context)));
    }
