...
public class SimpleObservation implements Observation {
    ...
    public final Map<Thread, Deque<Scope>> enclosingScopes = new ConcurrentHashMap<>();
    ...
    static class SimpleScope implements Scope {
        ...
        public void reset() {
            ...
            Deque<Scope> scopes = scope.currentObservation.enclosingScopes.get(Thread.currentThread());
            scopes.addFirst(this);
            NullScope nullScope = new NullScope(registry, scope.currentObservation);
            do {
            ...
            while (scope != null);
            this.registry.setCurrentObservationScope(nullScope);
        }
        ...
        public void makeCurrent() {
            ...
            this.currentObservation.notifyOnScopeReset(); // wywalic
        ...
        static class NullScope extends SimpleScope {

            NullScope(ObservationRegistry registry, SimpleObservation current) {
                super(registry, current);
            }
