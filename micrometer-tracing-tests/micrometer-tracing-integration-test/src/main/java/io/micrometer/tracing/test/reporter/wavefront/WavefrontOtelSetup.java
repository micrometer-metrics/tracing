...
public final class WavefrontOtelSetup implements AutoCloseable {
    ...
    public static class Builder {
        ...
        public WavefrontOtelSetup register(ObservationRegistry observationRegistry, MeterRegistry meterRegistry) {
            ...
            SdkTracerProvider sdkTracerProvider = this.sdkTracerProvider != null ? this.sdkTracerProvider.apply(wavefrontOTelSpanHandler) : sdkTracerProvider(wavefrontOTelSpanHandler, arrayListSpanProcessor);
            ...
            BiConsumer<BuildingBlocks, Deque<ObservationHandler<? extends Observation.Context>>> customizers = this.customizers != null ? this.customizers : (b, t) -> {
            };
            ...
            OtelBuildingBlocks otelBuildingBlocks = new OtelBuildingBlocks(wavefrontOTelSpanHandler, otelTracer, new OtelPropagator(propagators(Collections.singletonList(B3Propagator.injectingMultiHeaders())), tracer), httpServerHandler, httpClientHandler, customizers, arrayListSpanProcessor);
        ...
        private static SdkTracerProvider sdkTracerProvider(WavefrontOtelSpanHandler spanHandler, ArrayListSpanProcessor arrayListSpanProcessor) {
