...
class SpanAssertTests {
    ...
    void should_fail_when_remote_service_name_equal() {
        ...
        thenThrownBy(() -> assertThat(span).doesNotHaveRemoteServiceNameEqualTo("foo")).isInstanceOf(AssertionError.class);
    }
    ...
    void should_fail_when_kind_equal() {
        ...
        thenThrownBy(() -> assertThat(span).doesNotHaveKindEqualTo(Span.Kind.CLIENT)).isInstanceOf(AssertionError.class);
    }
