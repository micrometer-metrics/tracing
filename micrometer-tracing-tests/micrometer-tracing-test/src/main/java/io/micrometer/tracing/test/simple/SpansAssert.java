...
public class SpansAssert extends CollectionAssert<FinishedSpan> {
     ...
     * @throws AssertionError if the actual value is {@code null}.
     * @throws AssertionError if there is no span with the given name
     * @throws AssertionError if there is a span with the given name but the additional assertion is not successful
     *
     * @since 1.0.0
     */
     ...
     * @throws AssertionError if the actual value is {@code null}.
     * @throws AssertionError if there is no span with the given name (ignoring case)
     * @throws AssertionError if there is a span with the given name (ignoring case) but the additional assertion is not successful
     *
     * @since 1.0.0
     */
     ...
     * @return {@code this} assertion object.
     * @throws AssertionError if the actual value is {@code null}.
     * @throws AssertionError if the number of properly named spans is different from the desired one
     *
     * @since 1.0.0
     */
     ...
     *
     * @param spanName span name
     * @param expectedNumberOfSpans expected number of spans with the given name (ignoring case)
     * @return {@code this} assertion object.
     * @throws AssertionError if the actual value is {@code null}.
     * @throws AssertionError if the number of properly named spans is different from the desired one
     *
    ...
    /**
     * Syntactic sugar that extends {@link SpanAssert} methods with an option to
     * go back to {@link SpansAssert}.
     *
     * @since 1.0.0
     */
