 ...
 */
package io.micrometer.tracing.instrumentation.mongodb;
...
import io.micrometer.core.instrument.binder.mongodb.MongoHandlerContext;
...
public class MongoTracingObservationHandler implements TracingObservationHandler<MongoHandlerContext> {
	...
	private static final InternalLogger log = InternalLoggerFactory.getInstance(MongoTracingObservationHandler.class);
