...
import static io.micrometer.tracing.docs.DocumentedSpanAssertions.assertThatEventIsValid;
import static io.micrometer.tracing.docs.DocumentedSpanAssertions.assertThatKeyIsValid;
import static io.micrometer.tracing.docs.DocumentedSpanAssertions.assertThatNameIsValid;
import static io.micrometer.tracing.docs.DocumentedSpanAssertions.assertThatSpanStartedBeforeEnd;
import static io.micrometer.tracing.docs.DocumentedSpanAssertionsTests.MyEventsWithNotMatchingPrefix.A_BAR_EVENT;
import static io.micrometer.tracing.docs.DocumentedSpanAssertionsTests.MySpan.SPAN_WITH_DYNAMIC_ENTRIES;
import static io.micrometer.tracing.docs.DocumentedSpanAssertionsTests.MySpan.SPAN_WITH_EMPTY_TAGS_AND_EVENTS;
import static io.micrometer.tracing.docs.DocumentedSpanAssertionsTests.MySpan.SPAN_WITH_NOT_MATCHING_PREFIX;
import static io.micrometer.tracing.docs.DocumentedSpanAssertionsTests.MySpan.SPAN_WITH_PREFIX;
import static io.micrometer.tracing.docs.DocumentedSpanAssertionsTests.MyTags.A_FOO_TAG;
