...
abstract class HttpTracingRecordingListener<CTX extends IntervalHttpEvent, REQ extends HttpRequest, RES extends HttpResponse>
		implements TracingRecordingListener<CTX> {
	...
	HttpTracingRecordingListener(Tracer tracer, Function<REQ, Span> startFunction,
	...
	@Override
	public void onError(Timer.Sample intervalRecording, CTX ctx, Throwable throwable) {

	}

	@Override
	public void onStart(Timer.Sample intervalRecording, CTX event) {
	...
	@Override
	public void onRestore(Timer.Sample intervalRecording, CTX ctx) {
	...
	@Override
	public void onStop(Timer.Sample intervalRecording, CTX ctx, Timer timer,
			Duration duration) {
